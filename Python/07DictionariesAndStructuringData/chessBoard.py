...
1 | {} ||{}|| {} ||{}|| {} ||{}|| {} ||{}||
  |____||||||____||||||____||||||____||||||
  """
# three double quote characters in a row creates a multiline string that spans several lines of code.#
...
def print_help():
    ...
    print('commands: ')
    print(' move e2e4 - Moves the piece at e2 to e4 - Moves the piece at e2 to e4.')
